...
namespace Enes_Kurt_Odev___24._04._2023.Context;
...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<KritikseviyeUrunBilgileri> KritikseviyeUrunBilgileris { get; set; }
    ...
    public virtual DbSet<Enes_Kurt_Odev___24._04._2023.Models.Region> Regions { get; set; }
    ...
    public virtual DbSet<VwTop5Condiment> VwTop5Condiments { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<KritikseviyeUrunBilgileri>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("KritikseviyeUrunBilgileri");

            entity.Property(e => e.BirimFiyat)
                .HasColumnType("money")
                .HasColumnName("Birim Fiyat");
            entity.Property(e => e.Kategori).HasMaxLength(15);
            entity.Property(e => e.MinimumSiparişAdedi).HasColumnName("Minimum Sipariş Adedi");
            entity.Property(e => e.TedarikçiFirma)
                .HasMaxLength(40)
                .HasColumnName("Tedarikçi Firma");
            entity.Property(e => e.ÜrünAdı)
                .HasMaxLength(40)
        ...
        modelBuilder.Entity<Enes_Kurt_Odev___24._04._2023.Models.Region>(entity =>
        {
        ...
        modelBuilder.Entity<VwTop5Condiment>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_Top5Condiments");
